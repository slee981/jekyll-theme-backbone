...
Scaffold is *one-column minimalist Jekyll theme for bloggers*.
...
So is the target of the Jekyll theme Scaffold. It doesn't need to be modern, powerful, colorful, or beautiful; It just needs to be simple, proper, naked, and neat. Scaffold is empirical. Standing on it, you -- the blogger -- can build a great building based on your words.
